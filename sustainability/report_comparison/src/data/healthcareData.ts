...
const ihh: HealthcareEntity = {
  ...
  metrics: {
    ...
    // ── Social & governance ──
    women_leadership_pct: {
      value: 50,
      unit: "%",
      year: "2025",
      flag: "confirmed",
      citation: { ...IHH_SR2025, page: 47, pageNote: "People scorecard — women in leadership roles, p.47." },
      note: "Women in leadership roles (broad definition: senior + business-unit leaders), 2024: 49%, 2023: 42.5%. Target 50:50 male:female leaders by 2025.",
    },
    corruption_ops_pct: {
      value: 100,
      unit: "%",
...
const rmg: HealthcareEntity = {
  ...
  metrics: {
    ...
    women_board_pct: {
      ...
      year: "2025",
      flag: "confirmed",
      citation: { ...RMG_AR2025, page: 49, pageNote: "Board metrics — women on the Board, p.49." },
      note: "Women on the Board (2024: 18%).",
    },
    women_leadership_pct: {
      value: 40,
      unit: "%",
      year: "2025",
      flag: "confirmed",
      citation: { ...RMG_AR2025, page: 49, pageNote: "Women in management positions, p.49." },
      note: "Women in management positions. Basis differs from IHH's broader 'leadership' definition.",
    },
    women_workforce_pct: {
      value: 75,
      unit: "%",
